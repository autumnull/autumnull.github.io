movies["LUNGS"] = new movie(
	...
	[
		{item: load_img("Typhoid Mary/LUNGS_CAST/001-lungs+stuffPICT.png"), script: (x) => {
		x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 60 &&
			ev.y > 0 && ev.y < 100) {
				playing.goto("words")
		...
		{item: load_img("Typhoid Mary/LUNGS_CAST/002-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("pull")}}},
		{item: load_img("Typhoid Mary/LUNGS_CAST/003-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("pull")}}},
		{item: load_img("Typhoid Mary/LUNGS_CAST/004-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("pull")}}},
		{item: load_img("Typhoid Mary/LUNGS_CAST/005-.png"), script: (x) => {
		x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 60 &&
			ev.y > 0 && ev.y < 100) {
				playing.goto("words")
		...
		{item: new Audio("Typhoid Mary/LUNGS_CAST/012-sigh.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/LUNGS_CAST/013-faster breathing.2.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/LUNGS_CAST/014-mmm.wav"), script: (x) => {/**/}},
		null, // global script
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":16,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-5,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-9,"y":-2},{"style":"filter: invert(1); mix-blend-mode: difference; background: #ffffff;","kind":"text","index":6,"x":71,"y":167}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":16,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-5,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-9,"y":-2},{"style":"filter: invert(1); mix-blend-mode: difference; background: #ffffff;","kind":"text","index":7,"x":67,"y":120}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":16,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-5,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-9,"y":-2},{"style":"filter: invert(1); mix-blend-mode: difference; background: #ffffff;","kind":"text","index":8,"x":63,"y":121}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":22,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-5,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-9,"y":-2},{"style":"filter: invert(1); mix-blend-mode: difference; background: #ffffff;","kind":"text","index":9,"x":50,"y":136}]},
{"sounds":[null,null],"script":18,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-5,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-9,"y":-2},{"style":"filter: invert(1); mix-blend-mode: difference; background: #ffffff;","kind":"text","index":9,"x":50,"y":136}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
