movies["ORGANS"] = new movie(
	...
	[
		{item: load_img("Typhoid Mary/ORGANS_CAST/001-organs+PICT.png"), script: (x) => {
		x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 50 &&
			ev.y > 0 && ev.y < 50) {
		...
		{item: load_img("Typhoid Mary/ORGANS_CAST/007-.png"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary/ORGANS_CAST/008-.png"), script: (x) => {x.onmouseup = (ev) => {load_movie("MEDICAL", "brain")}}},
		{item: load_img("Typhoid Mary/ORGANS_CAST/009-.png"), script: (x) => {x.onmouseup = (ev) => {load_movie("MEDICAL", "heart")}}},
		...
		{item: new Audio("Typhoid Mary/ORGANS_CAST/011-short sleepgroan.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/ORGANS_CAST/012-sleepgroan.wav"), script: (x) => {/**/}},
		{item: null, script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/ORGANS_CAST/014-scratch.wav"), script: (x) => {/**/}},
		null, // global script
