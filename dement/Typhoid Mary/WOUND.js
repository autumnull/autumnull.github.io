movies["WOUND"] = new movie(
	{"quote1":14,"quote2":18,"quote3":22,"quote4":26,"quote5":30,"quote6":34,"fall":44,"timeout sequence":61,"wound":0,"words":39},
	[
		{item: load_img("Typhoid Mary/WOUND_CAST/001-wound+stuffPICT.png"), script: (x) => {
		x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 25 &&
			ev.y > 0 && ev.y < 75) {
		...
		{item: load_img("Typhoid Mary/WOUND_CAST/008-.png"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary/WOUND_CAST/009-.png"), script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary/WOUND_CAST/011-breath out.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/WOUND_CAST/012-mmm.wav"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary/WOUND_CAST/013-.png"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary/WOUND_CAST/014-.png"), script: (x) => {/**/}},
		{item: null, script: (x) => {/**/}},
		{item: null, script: (x) => {/**/}},
		{item: null, script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/WOUND_CAST/018-mmhuh.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/WOUND_CAST/019-scrape.wav"), script: (x) => {/**/}},
		null, // global script
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":26,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-4,"y":0},{"style":"filter: invert(1); mix-blend-mode: difference;","kind":"bitmap","index":8,"x":96,"y":272}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
