movies["HANDS"] = new movie(
	...
	[
		{item: load_img("Typhoid Mary/HANDS_CAST/001-hands+titsPICT.png"), script: (x) => {
		x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 50 &&
			ev.y > 0 && ev.y < 50) {
		...
		{item: load_img("Typhoid Mary/HANDS_CAST/009-.png"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary/HANDS_CAST/010-.png"), script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary/HANDS_CAST/012-scratch.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary/HANDS_CAST/013-zip.wav"), script: (x) => {/**/}},
		null, // global script
