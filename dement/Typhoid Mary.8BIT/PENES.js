movies["PENES"] = new movie(
	...
	[
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/001-cloth+severed penesPICT.png"), script: (x) => {
			x.onmouseup = (ev) => {
				if (ev.x > 0 && ev.x < 25 &&
				ev.y > 0 && ev.y < 50) {
		...
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/002-.png"), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/003-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("breathe")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/004-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("breathe")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/005-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("breathe")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/006-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("breathe")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/007-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("thrust")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/008-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("disappear")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/009-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("disappear")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/010-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("flick")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/011-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("flick")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/012-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("disappear")}}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/013-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("disappear")}}},
		{item: load_html('<div style="width: 529px; height: 196px; text-align: left"><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"... a programming language is a medium not only for expressing </span><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold; font-style: italic;">representations</span><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">  but also for bringing about the </span><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold; font-style: italic;">representational activity</span><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">  of certain machines."<br/><br/></span><span style="color: #d6d6d6; font-size: 18px; line-height: 19px; font-family: Times; ">Margaret A Boden: ESCAPING FROM THE CHINESE ROOM extracted from Chapter 8 of COMPUTER MODELS OF MIND 1988, Cambridge University Press.<br/></span></div>'), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/015-.png"), script: (x) => {/**/}},
		{item: load_html('<div style="width: 529px; height: 196px; text-align: left"><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"The inherant procedural consequences of any computer program give it a toehold in semantics, where the semantics in question is not denotational but causal."<br/><br/></span><span style="color: #d6d6d6; font-size: 18px; line-height: 19px; font-family: Times; ">Margaret A Boden: ESCAPING FROM THE CHINESE ROOM extracted from Chapter 8 of COMPUTER MODELS OF MIND 1988, Cambridge University Press.<br/></span></div>'), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary.8BIT/PENES_CAST/017-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("thrust")}}},
		{item: load_html('<div style="width: 411px; height: 72px; text-align: center"><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">He only knows he\'s a man when his cock\'s in your arse.<br/></span></div>'), script: (x) => {/**/}},
		{item: load_html('<div style="width: 529px; height: 201px; text-align: left"><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"And as long as psychoanalysts maintain the separability of \'phallus\' from \'penis\', they can hold on to their \'phallus\' in the belief that their discourse has no relation to sexual inequality, no relation to politics."<br/><br/></span><span style="color: #d6d6d6; font-size: 18px; line-height: 19px; font-family: Times; ">Jane Gallop: FEMINISM AND PSYCHOANALYSIS: THE DAUGHTER\'S SEDUCTION, Macmillan Press, London, 1982, p97<br/></span></div>'), script: (x) => {/**/}},,
		...
		{item: load_html('<div style="width: 499px; height: 148px; text-align: left"><span style="color: #d6d6d6; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"We mustn\'t leave them a single place that\'s any more theirs alone than we are."<br/><br/></span><span style="color: #d6d6d6; font-size: 18px; line-height: 19px; font-family: Times; ">Helene Cixous: THE LAUGH OF THE MEDUSA, trans Keith & Paula Cohen, THEORY AND HISTORY OF LITERATURE vol 35, University of Minnesota Press, Minneapolis, 1985, p258<br/></span></div>'), script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary.8BIT/PENES_CAST/023-squeak.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary.8BIT/PENES_CAST/024-scratch.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary.8BIT/PENES_CAST/025-mmm.wav"), script: (x) => {/**/}},
		{item: new Audio("Typhoid Mary.8BIT/PENES_CAST/026-faster breathing.2.wav"), script: (x) => {/**/}},
		null, // global script
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":29,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-4,"y":-3},{"style":"opacity: 0.501961;","kind":"bitmap","index":14,"x":-1,"y":-1},{"style":"","kind":"text","index":13,"x":57,"y":155}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":29,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-4,"y":-3},{"style":"opacity: 0.501961;","kind":"bitmap","index":14,"x":-1,"y":-1},{"style":"","kind":"text","index":17,"x":91,"y":203}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":29,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-4,"y":-3},{"style":"opacity: 0.501961;","kind":"bitmap","index":14,"x":-1,"y":-1},{"style":"","kind":"text","index":18,"x":57,"y":134}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":29,"sprites":[{"style":"","kind":"bitmap","index":0,"x":-4,"y":-3},{"style":"opacity: 0.501961;","kind":"bitmap","index":14,"x":-1,"y":-1},{"style":"","kind":"text","index":20,"x":68,"y":168}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
