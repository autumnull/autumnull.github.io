movies["ARM"] = new movie(
	...
	[
		{
			item: load_img("Typhoid Mary.8BIT/ARM_CAST/001-arm+mouth+cutPICT.png"),
		...
		{item: load_img("Typhoid Mary.8BIT/ARM_CAST/005-.png"), script: (x) => {/**/}},
		{item: load_html('<div style="width: 607px; height: 432px; text-align: left"><span style="color: #9c949c; font-size: 48px; line-height: 48px; font-family: Times; ">Cut<br/><br/>         wet<br/><br/><br/><br/><br/><br/>    like at the touch of a lover</span></div>'), script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary.8BIT/ARM_CAST/009-short sleepgroan.wav"), script: (x) => {}},
		null,
		{item: new Audio("Typhoid Mary.8BIT/ARM_CAST/011-faster breathing.2.wav"), script: (x) => {}},
		null, // global script
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":15,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"","kind":"text","index":5,"x":17,"y":24}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
