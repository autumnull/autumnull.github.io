movies["ANIMATIONS"] = new movie(
	...
	[
		{
			item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/001-.png"),
			script: (x) => {x.onmouseup = (ev) => {load_movie("SCAR")}}
		},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/002-.png"), script: (x) => {}},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/003-.png"), script: (x) => {}},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/004-.png"), script: (x) => {}},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/005-.png"), script: (x) => {}},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/006-.png"), script: (x) => {}},
		{item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/007-.png"), script: (x) => {}},
		{
			item: load_img("Typhoid Mary.8BIT/ANIMATIONS_CAST/008-.png"),
