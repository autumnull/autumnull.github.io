movies["GLOTTIS"] = new movie(
	...
	[
		{
			item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/001-glottis+stuffPICT.png"),
		...
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/002-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("spread")}}},
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/003-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("bend")}}},
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/004-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("glottis")}}},
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/005-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("glottis")}}},
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/006-.png"), script: (x) => {}},
		{item: load_html('<div style="width: 533px; height: 234px; text-align: left"><span style="color: #bdbdbd; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"...if the other caves in and withdraws under my act, my act drops off the edge of that emptiness and I feel that I will soon follow. In this void, the fear of the boundless begins."<br/></span><span style="color: #bdbdbd; font-size: 18px; line-height: 19px; font-family: Times;  font-weight: bold;"><br/></span><span style="color: #bdbdbd; font-size: 18px; line-height: 19px; font-family: Times; ">Jessica Benjamin: THE BONDS OF LOVE: RATIONAL VIOLENCE AND EROTIC DOMINATION, from THE FUTURE OF DIFFERENCE by Hester Eisenstein & Alice Jardine, Copyright Ⓒ 1985 by Rutgers University, The State University of New Jersey.</span><span style="color: #000000; font-size: 18px; line-height: 19px; font-family: Times; "><br/></span></div>'), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/008-.png"), script: (x) => {/**/}},
		{item: load_html('<div style="width: 533px; height: 215px; text-align: left"><span style="color: #bdbdbd; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"To learn a language is to set up the relevant causal connections, not only between words and the world but between words and the many non-introspectable procedures involved in interpreting them."<br/></span><span style="color: #bdbdbd; font-size: 18px; line-height: 19px; font-family: Times;  font-weight: bold;"><br/></span><span style="color: #bdbdbd; font-size: 18px; line-height: 19px; font-family: Times; ">Margaret A Boden: ESCAPING FROM THE CHINESE ROOM extracted from Chapter 8 of COMPUTER MODELS OF MIND 1988, Cambridge University Press.<br/></span></div>'), script: (x) => {/**/}},
		{item: load_html('<div style="width: 554px; height: 220px; text-align: left"><span style="color: #bdbdbd; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">(a programmed instruction) "...is not a mere formal pattern - nor even a declarative statement... It is a procedure specification that given a suitable hardware context, can cause the procedure in question to be executed."<br/><br/></span><span style="color: #bdbdbd; font-size: 18px; line-height: 19px; font-family: Times; ">Margaret A Boden: ESCAPING FROM THE CHINESE ROOM extracted from Chapter 8 of COMPUTER MODELS OF MIND 1988, Cambridge University Press.<br/></span></div>'), script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary.8BIT/GLOTTIS_CAST/015-breath out.wav"), script: (x) => {}},
		{item: new Audio("Typhoid Mary.8BIT/GLOTTIS_CAST/016-squeak.wav"), script: (x) => {}},
		null,
		{item: new Audio("Typhoid Mary.8BIT/GLOTTIS_CAST/018-scrape.wav"), script: (x) => {}},
		{item: new Audio("Typhoid Mary.8BIT/GLOTTIS_CAST/019-breathing2.wav"), script: (x) => {}},
		null, // global script
		...
		{item: load_img("Typhoid Mary.8BIT/GLOTTIS_CAST/032-Suck My Cock.png"), script: (x) => {x.onmouseup = (ev) => {
			if (ev.x > 0 && ev.x < 24 &&
			 ev.y > 0 && ev.y < 150) {
				load_movie("SCAR", "close");
			} else if (ev.x > 24 && ev.x < 34 &&
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":21,"sprites":[{"style":"","kind":"bitmap","index":31,"x":0,"y":0}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":21,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":6,"x":53,"y":128}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":21,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":8,"x":55,"y":121}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":21,"sprites":[{"style":"","kind":"bitmap","index":31,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":9,"x":60,"y":151}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":27,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":11,"x":62,"y":156}]},
{"sounds":[null,null],"script":20,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":11,"x":62,"y":156}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":21,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":7,"x":-1,"y":-1},{"style":"","kind":"text","index":12,"x":58,"y":125}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
