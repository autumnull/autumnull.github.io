movies["SCAR"] = new movie(
	...
	[
		{
			item: load_img("Typhoid Mary.8BIT/SCAR_CAST/001-scar+stuffPICT.png"),
		...
		{item: load_img("Typhoid Mary.8BIT/SCAR_CAST/002-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("kiss")}}},
		{item: load_img("Typhoid Mary.8BIT/SCAR_CAST/003-.png"), script: (x) => {x.onmouseup = (ev) => {playing.goto("close")}}},
		{item: load_img("Typhoid Mary.8BIT/SCAR_CAST/004-.png"), script: (x) => {}},
		{item: load_html('<div style="width: 551px; height: 244px; text-align: left"><span style="color: #8c8484; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"Everything is false in fantasy. And everything is false with a lie that knows neither hesitation nor shame... The truth as pursued by science is true only provided that it be without meaning, and nothing has meaning unless it be fiction."<br/><br/></span><span style="color: #8c8484; font-size: 18px; line-height: 19px; font-family: Times; ">Georges Bataille: VISIONS OF EXCESS, (trans & ed) Allan Stoekl, Theory and History of Literature vol 14, University of Minnesota Press, Minneapolis, 1985<br/></span></div>'), script: (x) => {/**/}},
		{item: load_img("Typhoid Mary.8BIT/SCAR_CAST/006-.png"), script: (x) => {/**/}},
		{item: load_html('<div style="width: 552px; height: 225px; text-align: left"><span style="color: #8c8484; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"...sexual violence causes a wound that rarely heals of its own accord; it has to be closed, and will not remain closed without constant attention based on anguish. Primary anguish bound up with sexual disturbance signifies death."<br/><br/></span><span style="color: #8c8484; font-size: 18px; line-height: 19px; font-family: Times; ">Georges Bataille: EROTISM: DEATH AND SENSUALITY , trans Mary Dalwood, City Light Books, San Francisco, 1986<br/></span></div>'), script: (x) => {/**/}},
		{item: load_html('<div style="width: 529px; height: 129px; text-align: left"><span style="color: #8c8484; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"The division between men and women is lived as a division within woman."<br/><br/></span><span style="color: #8c8484; font-size: 18px; line-height: 19px; font-family: Times; ">Jane Gallop: FEMINISM AND PSYCHOANALYSIS:THE DAUGHTER\'S SEDUCTION, Macmillan Press, London, 1982, p106<br/></span></div>'), script: (x) => {/**/}},
		{item: load_html('<div style="width: 547px; height: 244px; text-align: left"><span style="color: #8c8484; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"Artist, politicians and scientists have the responsibility of lying to him; those who dominate existence in this way are almost always those who know best how to lie to themselves, hence those who lie best to others."<br/><br/></span><span style="color: #8c8484; font-size: 18px; line-height: 19px; font-family: Times; ">Georges Bataille: VISIONS OF EXCESS, trans & ed Allan Stoekl, THEORY AND HISTORY OF LITERATURE, vol 14, University of Minnesota Press, Minneapolis, 1985, p224 <br/></span></div>'), script: (x) => {/**/}},
		{item: load_html('<div style="width: 511px; height: 167px; text-align: left"><span style="color: #8c8484; font-size: 24px; line-height: 24px; font-family: Times;  font-weight: bold;">"Censor the body and you censor breath and speech at the same time."<br/><br/></span><span style="color: #8c8484; font-size: 18px; line-height: 19px; font-family: Times; ">Helene Cixous: THE LAUGH OF THE MEDUSA, from NEW FRENCH FEMINISMS, trans Keith & Paule Cohen, THEORY AND HISTORY OF LITERATURE vol 35, University of Minnesota Press, Minneapolis, 1985, p 251<br/></span></div>'), script: (x) => {/**/}},
		{item: null, script: (x) => {/**/}},
		...
		{item: new Audio("Typhoid Mary.8BIT/SCAR_CAST/012-sigh.wav"), script: (x) => {}},
		{item: new Audio("Typhoid Mary.8BIT/SCAR_CAST/013-scrape.wav"), script: (x) => {}},
		{item: new Audio("Typhoid Mary.8BIT/SCAR_CAST/014-mmhuh.wav"), script: (x) => {}},
		null, // global script
...
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":23,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":4,"x":49,"y":126}]},
{"sounds":[null,null],"script":24,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":4,"x":49,"y":126}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":22,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":6,"x":44,"y":121}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":22,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":7,"x":58,"y":176}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":23,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":8,"x":57,"y":116}]},
{"sounds":[null,null],"script":15,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":8,"x":57,"y":116}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"script":19,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":9,"x":57,"y":170}]},
{"sounds":[null,null],"script":18,"sprites":[{"style":"","kind":"bitmap","index":0,"x":0,"y":0},{"style":"opacity: 0.501961;","kind":"bitmap","index":5,"x":-3,"y":0},{"style":"","kind":"text","index":9,"x":57,"y":170}]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
{"sounds":[null,null],"sprites":[]},
